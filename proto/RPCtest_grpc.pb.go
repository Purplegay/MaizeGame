...
type SumClient interface {
	// Sends a greeting
	SayHello(ctx context.Context, in *SumNumsREQ, opts ...grpc.CallOption) (*SumNumsACK, error)
}
...
func (c *sumClient) SayHello(ctx context.Context, in *SumNumsREQ, opts ...grpc.CallOption) (*SumNumsACK, error) {
	out := new(SumNumsACK)
	err := c.cc.Invoke(ctx, "/myproto.Sum/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SumServer interface {
	// Sends a greeting
	SayHello(context.Context, *SumNumsREQ) (*SumNumsACK, error)
...
func (UnimplementedSumServer) SayHello(context.Context, *SumNumsREQ) (*SumNumsACK, error) {
...
func _Sum_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumNumsREQ)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SumServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/myproto.Sum/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServer).SayHello(ctx, req.(*SumNumsREQ))
	}
...
var Sum_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "myproto.Sum",
	HandlerType: (*SumServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _Sum_SayHello_Handler,
		},
	},
